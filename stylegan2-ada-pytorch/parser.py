...
def get_parser():
    ...
    parser.add_argument('--channel_max_g', help='Override max width of generator', type=int)
    parser.add_argument('--channel_max_d', help='Override max width of discriminator', type=int)
